"""
get_lake_facts.py — DNR lake facts for Legend Lake (Menominee County, WI)
...
def main():
    ...
    out = {
        "name": grab(r"Name ([A-Za-z .']+?) Waterbody", facts) or "Legend Lake",
        "wbic": WBIC,
        "county": grab(r"County (\w+) Region", facts) or "Menominee",
